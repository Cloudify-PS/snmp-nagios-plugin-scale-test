...
sudo sed -i s/1.3.6.1.4.1.2021.10.1.3.1\|4:numeric\|scale=15,rate=0.01,deviation=1,function=cos,min=0/1.3.6.1.4.1.2021.10.1.3.1\|4:numeric\|scale=1,rate=0.01,deviation=1,function=cos,min=0,max=0.45/g /usr/snmpsim/data/cloudify_monitoring.snmprec
sudo sed -i s/1.3.6.1.4.1.2021.10.1.3.2\|4:numeric\|scale=10,rate=0.005,deviation=1,function=cos,min=0/1.3.6.1.4.1.2021.10.1.3.2\|4:numeric\|scale=1,rate=0.01,deviation=1,function=cos,min=0.51,max=0.69/g /usr/snmpsim/data/cloudify_monitoring.snmprec
